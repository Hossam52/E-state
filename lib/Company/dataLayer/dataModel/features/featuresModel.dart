class GetAllFeaturesCompanyModel {
  bool? status;
  Units? units;

  GetAllFeaturesCompanyModel({this.status, this.units});

  GetAllFeaturesCompanyModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
...
class Units {
  ...
  Units.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <DataFeatures>[];
      json['data'].forEach((v) {
        data!.add(new DataFeatures.fromJson(v));
      });
    }
    links = json['links'] != null ? new Links.fromJson(json['links']) : null;
    meta =
        json['meta'] != null ? new MetaUnitData.fromJson(json['meta']) : null;
  }
...
class DataFeatures {
  ...
  DataFeatures.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    title = json['title'];
    type = json['type'];
...
class MetaUnitData {
  ...
  MetaUnitData.fromJson(Map<String, dynamic> json) {
