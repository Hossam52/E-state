class PopularListModel {
  bool? status;
  UnitsOfDetected? units;

  PopularListModel({this.status, this.units});

  PopularListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    units = json['units'] != null
        ? new UnitsOfDetected.fromJson(json['units'])
        : null;
  }
...
class UnitsOfDetected {
  List<DataDetected>? data;
  Links? links;
  Meta? meta;

  UnitsOfDetected({this.data, this.links, this.meta});

  UnitsOfDetected.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <DataDetected>[];
      json['data'].forEach((v) {
        data!.add(new DataDetected.fromJson(v));
      });
    }
...
class DataDetected {
  ...
  DataDetected.fromJson(Map<String, dynamic> json) {
    city = json["city"];
